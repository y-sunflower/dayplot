...
def calendar(
    ...
    **kwargs,
    ...
    - `kwargs`: Any additional arguments that will be passed to matplotlib.patches.FancyBboxPatch. For example, you can set `alpha`, `hatch`, `linestyle`, etc. You can find them all here: https://matplotlib.org/stable/api/_as_gen/matplotlib.patches.FancyBboxPatch.html
